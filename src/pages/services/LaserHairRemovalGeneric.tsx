  ...
  const pricingTabs = [
    {
      label: "Women's",
      prices: [
        { area: "Upper Lip", singleSession: "£40", course: "£180", savings: "Save £60", popular: true },
        { area: "Underarms", singleSession: "£55", course: "£250", savings: "Save £80", popular: true },
        { area: "Bikini Line", singleSession: "£55", course: "£250", savings: "Save £80", popular: true },
        { area: "Brazilian", singleSession: "£95", course: "£430", savings: "Save £140", popular: true },
        ...
        { area: "Full Body", singleSession: "£300", course: "£1,200", savings: "6-session course", popular: true },
