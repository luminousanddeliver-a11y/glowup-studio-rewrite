...
const categoryOrder = ["laser-women", "laser-men", "facials", "peels", "skin-rejuvenation", "lesions", "pigmentation", "injectables", "removal", "wellness"];
...
const Prices = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-background">
      <SEOHead title="Prices | Laser Hair Removal & Skin Treatment Costs | Dagenham" description="View our treatment prices for laser hair removal, HydraFacials, Botox, tattoo removal and more. Free consultation available. Transparent pricing at Laser Light Skin Clinic Dagenham." canonicalUrl="https://laserlightskinclinic.co.uk/prices" structuredData={priceSchema} />
              ...
              duration: 0.4
                ...
                <div className={`${isMobile ? 'overflow-x-auto pb-2 -mx-4 px-4' : 'flex justify-center'}`}>
                  <TabsList className={`${isMobile ? 'inline-flex w-max' : 'inline-flex flex-wrap justify-center'} h-auto gap-2 bg-transparent p-0`}>
                    {categoryOrder.map(key => <TabsTrigger key={key} value={key} className="whitespace-nowrap px-4 py-2 text-sm rounded-full border border-border bg-card data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary hover:bg-muted transition-colors">
                        {categoryLabels[key]}
                      </TabsTrigger>)}
                  </TabsList>
                </div>
                  ...
                  duration: 0.4
                      ...
                      <div className="p-6 border-b border-border">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                          ...
                          {category.courseLabel && category.courseLabel !== "—" && category.courseLabel !== "Per Session" && <div className="text-sm text-muted-foreground font-body">
                              Buy 6, Get 2 Free
                            </div>}
                        </div>
                      </div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full">
                          ...
                          <tbody>
                            {category.treatments.map((treatment, index) => <motion.tr key={treatment.name} initial={{
                          opacity: 0,
                          x: -10
                        }} animate={{
                          opacity: 1,
                          ...
                          delay: index * 0.02
                                ...
                                <td className="p-4 font-body text-foreground">
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    {treatment.popular && <span className="bg-accent/10 text-accent text-xs px-2 py-0.5 rounded-full font-medium">
                                        Popular
                                      </span>}
                                    {treatment.note && <span className="text-muted-foreground text-xs">
                                        ({treatment.note})
                                      </span>}
                                  </div>
                                </td>
                      ...
                      {/* Category Note */}
                      {category.note && <div className="p-4 bg-muted/30 border-t border-border">
