...
const priceCategories: Record<string, PriceCategory> = {
  "laser-women": {
    ...
    treatments: [
      { name: "Full Body", single: "—", course: "£1,200", savings: "Save £2,400", popular: true },
      { name: "Underarms & Hollywood", single: "£225", course: "£500", savings: "Save £850", popular: true },
      { name: "Underarms, Brazilian & Half Legs", single: "£345", course: "£900", savings: "Save £1,170", popular: true },
      { name: "Full Face (inc. Neck or Forehead)", single: "£140", course: "£450", savings: "Save £390", popular: true, note: "Includes neck or forehead, not both" },
      { name: "Upper Lip", single: "£45", course: "£200", savings: "Save £70" },
      { name: "Chin", single: "£50", course: "£200", savings: "Save £100" },
      { name: "Lip & Chin", single: "£80", course: "£250", savings: "Save £230", popular: true },
      { name: "Sideburns", single: "£70", course: "£250", savings: "Save £170" },
      { name: "Jawline", single: "£45", course: "£200", savings: "Save £70" },
      { name: "Neck", single: "£45", course: "£200", savings: "Save £70" },
      { name: "Ears", single: "£40", course: "£190", savings: "Save £50" },
      { name: "Half Face", single: "£110", course: "£420", savings: "Save £240" },
      { name: "Underarms", single: "£85", course: "£300", savings: "Save £210" },
      { name: "Bikini Line", single: "£55", course: "£220", savings: "Save £110" },
      { name: "Brazilian", single: "£140", course: "£450", savings: "Save £390", popular: true },
      { name: "Hollywood", single: "£110", course: "£420", savings: "Save £240" },
      { name: "Buttocks", single: "£110", course: "£420", savings: "Save £240" },
      { name: "Half Arms", single: "£100", course: "£350", savings: "Save £250" },
      { name: "Full Arms", single: "£180", course: "£550", savings: "Save £530" },
      { name: "Hands & Fingers", single: "£40", course: "£190", savings: "Save £50" },
      { name: "Half Legs (Lower)", single: "£150", course: "£550", savings: "Save £350" },
      { name: "Full Legs", single: "£240", course: "£650", savings: "Save £790", popular: true },
      { name: "Stomach Line", single: "£45", course: "£200", savings: "Save £70" },
      { name: "Full Stomach", single: "£150", course: "£550", savings: "Save £350" },
      { name: "Lower Back", single: "£60", course: "£240", savings: "Save £120" },
      { name: "Full Back", single: "£150", course: "£550", savings: "Save £350" },
      { name: "Chest", single: "£100", course: "£350", savings: "Save £250" },
      { name: "Chest Line", single: "£60", course: "£240", savings: "Save £120" },
      { name: "Nipples", single: "£30", course: "£140", savings: "Save £40" },
      { name: "Shoulders", single: "£60", course: "£260", savings: "Save £100" },
    ],
      ...
      <div className="p-4 md:p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto">
          <Button
            asChild
            variant="outline"
            className="w-full border-accent text-accent hover:bg-accent hover:text-primary font-semibold group-hover:bg-accent/5 transition-colors"
          >
            <a href="https://www.phorest.com/salon/laserlightskinclinic/buy/course" target="_blank" rel="noopener noreferrer">
              Buy Series
            </a>
          </Button>
        </div>
