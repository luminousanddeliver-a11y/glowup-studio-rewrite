  ...
  const faqPageSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. We use the Quanta Thunder, which is guaranteed pain-free. Its advanced cooling system and advanced laser technology ensure a comfortable experience, even on sensitive areas like the bikini line."
        }
      },
      {
        "@type": "Question",
