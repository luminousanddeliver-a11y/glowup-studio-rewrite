...
const Contact = () => {
  ...
  const contactItems = [{
    icon: MapPin,
    title: "Address",
    content: <p className="font-body text-muted-foreground">
    ...
    icon: Phone,
    title: "Phone",
    content: <div className="font-body text-muted-foreground space-y-1">
    ...
    icon: Mail,
    title: "Email",
    content: <a href="mailto:info@laserlightskinclinic.co.uk" className="font-body text-muted-foreground hover:text-accent transition-colors">
          info@laserlightskinclinic.co.uk
        </a>
  }, {
    icon: Clock,
    title: "Opening Hours",
    content: <div className="font-body text-muted-foreground space-y-1 text-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              duration: 0.6
                ...
                <div className="space-y-6">
                  {contactItems.map((item, index) => <motion.div key={item.title} className="flex items-start gap-4" initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
                  ...
                  delay: index * 0.1
                      ...
                      <motion.div className="w-12 h-12 bg-accent/10 rounded-full flex items-center justify-center shrink-0" whileHover={{
                    scale: 1.1
                  }} transition={{
                    type: "spring",
                    stiffness: 300
                ...
                <motion.div className="mt-8 rounded-lg overflow-hidden shadow-card" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                delay: 0.4
                  ...
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2478.7657412826285!2d0.1173976!3d51.5545814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a556bfa82c13%3A0x6ebb4d999d740f14!2sLaser%20Light%20Skin%20Clinic!5e0!3m2!1sen!2suk!4v1706300000000!5m2!1sen!2suk" width="100%" height="280" style={{
                  border: 0
                }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Laser Light Skin Clinic - 125 Becontree Avenue, Dagenham" className="w-full" />
                </motion.div>

                {/* Parking & Transport Info */}
                <motion.div className="mt-6 bg-accent/5 rounded-lg p-6 border border-accent/10" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                ...
                <motion.a href="https://www.google.com/maps/place/Laser+Light+Skin+Clinic/@51.5545221,0.1175882,17z/data=!4m16!1m9!3m8!1s0x47d8a556bfa82c13:0x6ebb4d999d740f14!2sLaser+Light+Skin+Clinic!8m2!3d51.5545814!4d0.1173976!9m1!1b1!16s%2Fg%2F11h4nbjdlz!3m5!1s0x47d8a556bfa82c13:0x6ebb4d999d740f14!8m2!3d51.5545814!4d0.1173976!16s%2Fg%2F11h4nbjdlz" target="_blank" rel="noopener noreferrer" className="mt-6 flex items-center gap-4 bg-card p-5 rounded-lg border border-border hover:border-accent/30 transition-colors group" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        ...formData,
                        name: e.target.value
                      })} placeholder="Your name" required className="border-border focus:border-primary" />
                      </div>
                      <div className="space-y-2">
                      ...
                      })} placeholder="your@email.com" required className="border-border focus:border-primary" />
                      </div>
                    </div>
                    ...
                    })} placeholder="Tell us about your requirements..." rows={5} required className="border-border focus:border-primary" />
                    </div>
