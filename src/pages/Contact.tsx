...
const Contact = () => {
  ...
  const openingHours = [
    { day: "Monday", hours: "10:00 AM - 7:00 PM", highlight: false },
    { day: "Tuesday", hours: "10:00 AM - 7:00 PM", highlight: true },
    { day: "Wednesday", hours: "10:00 AM - 7:00 PM", highlight: false },
    { day: "Thursday", hours: "10:00 AM - 8:00 PM", highlight: false },
    { day: "Friday", hours: "10:00 AM - 7:00 PM", highlight: false },
    { day: "Saturday", hours: "10:00 AM - 6:00 PM", highlight: false },
          ...
          <div className="container-custom">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="space-y-2.5">
                  {openingHours.map((item) => (
                    <div 
                      key={item.day} 
                      className={`flex justify-between items-center text-sm ${item.highlight ? 'text-accent font-medium' : ''}`}
                    >
              ...
              >
                ...
                <Button
                  asChild
                  className="w-full h-12 bg-card hover:bg-card/90 text-accent font-semibold border-0"
                >
