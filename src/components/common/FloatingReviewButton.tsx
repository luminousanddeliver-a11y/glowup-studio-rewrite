...
export const FloatingReviewButton = () => {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-24 right-4 md:bottom-6 md:right-6 z-40 flex items-center gap-2 bg-gold text-gold-foreground px-4 py-3 rounded-full shadow-lg hover:bg-gold/90 transition-colors group"
